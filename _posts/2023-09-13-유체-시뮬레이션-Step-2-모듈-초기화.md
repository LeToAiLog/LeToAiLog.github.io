...
Cube는 [**`Pandas`**](https://pandas.pydata.org/)를 사용하여 미리 저장된 csv 파일을 읽어서 불러온다.
...
|       ⋮        |     ⋮      |     ⋮      |      ⋮      |
_**<span style="color:deepskyblue; font-size:150%">Table 1. </span>
<span style="color:gainsboro;font-size:150%"> The position of the particles is separated into x, y, and z axes, and the values for each particle are shown in the table.</span>**_
